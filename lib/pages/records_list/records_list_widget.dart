            ...
            children: [
              ...
              Expanded(
                child: PagedListView<DocumentSnapshot<Object?>?,
                  ...
                  builderDelegate: PagedChildBuilderDelegate<RecordsRecord>(
                    ...
                    itemBuilder: (context, _, listViewIndex) {
                      final listViewRecordsRecord = _model
                      ...
                      return InkWell(
                        ...
                        onDoubleTap: () async {
                          if (listViewRecordsRecord.receivedBy == '') {
                            ...
                            if (confirmDialogResponse) {
                              ...
                              await listViewRecordsRecord.reference.update({
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (_model.adjustedFixDateCopy != null) {
                                      ...
                                      await listViewRecordsRecord.reference
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        dateTimeFormat(
                                            "MMM", listViewRecordsRecord.date!),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Readex Pro',
                                              color: listViewRecordsRecord
                                                              .receivedBy ==
                                                          ''
                                                      ...
                                                      style:
                                                          FlutterFlowTheme.of(
                                                              ...
                                                              .override(
                                                                fontFamily:
                                                                    'Readex Pro',
                                                                color: listViewRecordsRecord.receivedBy ==
                                                                            ''
                                                                    ? FlutterFlowTheme.of(
                                                                            context)
                                                                        .error
