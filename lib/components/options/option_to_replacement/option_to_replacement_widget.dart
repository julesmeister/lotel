...
import 'option_to_replacement_model.dart';
export 'option_to_replacement_model.dart';

class OptionToReplacementWidget extends StatefulWidget {
  ...
  State<OptionToReplacementWidget> createState() =>
      _OptionToReplacementWidgetState();
}

class _OptionToReplacementWidgetState extends State<OptionToReplacementWidget> {
  late OptionToReplacementModel _model;
                    ...
                    onTap: () async {
                      if (valueOrDefault(currentUserDocument?.role, '') ==
                        ...
                        if (confirmDialogResponse) {
                          // delete replacement
                          await widget.replacement!.reference.delete();
                          Navigator.pop(context);
