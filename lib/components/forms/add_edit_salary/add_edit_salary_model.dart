...
import 'add_edit_salary_widget.dart' show AddEditSalaryWidget;
import 'package:flutter/material.dart';

class AddEditSalaryModel extends FlutterFlowModel<AddEditSalaryWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in AddEditSalary widget.
