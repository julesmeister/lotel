...
class AddEditLocationWidget extends StatefulWidget {
  const AddEditLocationWidget({
    super.key,
    this.location,
  });
  ...
  @override
  State<AddEditLocationWidget> createState() => _AddEditLocationWidgetState();
}

class _AddEditLocationWidgetState extends State<AddEditLocationWidget> {
  late AddEditLocationModel _model;
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'Enter new location here',
