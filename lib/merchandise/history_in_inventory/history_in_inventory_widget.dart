...
class HistoryInInventoryWidget extends StatefulWidget {
  const HistoryInInventoryWidget({super.key});

  @override
  State<HistoryInInventoryWidget> createState() =>
      _HistoryInInventoryWidgetState();
}

class _HistoryInInventoryWidgetState extends State<HistoryInInventoryWidget>
    with TickerProviderStateMixin {
  late HistoryInInventoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HistoryInInventoryModel());
