...
class _RemittanceSpecificTransactionsWidgetState
    extends State<RemittanceSpecificTransactionsWidget>
    with TickerProviderStateMixin {
  late RemittanceSpecificTransactionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RemittanceSpecificTransactionsModel());
