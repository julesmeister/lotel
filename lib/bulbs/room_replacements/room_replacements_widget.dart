...
import 'room_replacements_model.dart';
export 'room_replacements_model.dart';

class RoomReplacementsWidget extends StatefulWidget {
  const RoomReplacementsWidget({
    super.key,
  ...
  @override
  State<RoomReplacementsWidget> createState() => _RoomReplacementsWidgetState();
}

class _RoomReplacementsWidgetState extends State<RoomReplacementsWidget>
    with TickerProviderStateMixin {
  late RoomReplacementsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RoomReplacementsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ReplacementRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReplacementRecord> roomReplacementsReplacementRecordList =
            snapshot.data!;
                ...
                children: [
                  ...
                  Expanded(
                    child: Builder(
                      builder: (context) {
                        final replacement =
                            roomReplacementsReplacementRecordList.toList();
